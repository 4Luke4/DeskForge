...
The 0.6.0 graphics-service failure string and the 0.5.0 audio and microphone strings are translated
but remain covered by each locale's pending human-review gate.
